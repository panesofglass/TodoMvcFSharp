module TodoMvcFSharp.TodoBackend
...
let todoStorage = Agent<_>.Start(fun inbox ->
    let rec loop todos = async {
        ...
        | Update todo ->
            ...
            if todos'.Length = todos.Length then
                return! loop todos // TODO: Handle the 404 scenario
            else
                return! loop (todo::todos')
        | Delete uri ->
